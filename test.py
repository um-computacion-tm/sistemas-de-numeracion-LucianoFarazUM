...
import unittest
from codigo_numeracion import binary_to_decimal, binary_to_octal, binary_to_hexadecimal, decimal_to_binary, decimal_to_octal, decimal_to_hexadecimal, octal_to_binary, octal_to_decimal, octal_to_hexadecimal, hexadecimal_to_binary, hexadecimal_to_decimal, hexadecimal_to_octal
